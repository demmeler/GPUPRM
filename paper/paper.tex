...
Boltzmannstraße 3,
85748 Garching by Munich \\ 
\email{manfred.liebmann@tum.de, manuel.demmeler@yahoo.de}
}
...
A common algorithm is the probabilistic roadmap method (PRM), which gives efficient approximative solutions and scales well with high dimensions of the underlying spaces.
%
...
%
In this paper, the PRM method has been parallelized.
A first level of parallelization is achieved by GPU support.
A CUDA kernel has been implemented that runs robot kinematics calculations and collision detection for different robot configurations in parallel.
