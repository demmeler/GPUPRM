...
int ArrayConfigspace::indicator2_async(const float* qs, const float* qe, int *res, const int N, const int offset, int &request){
    return indicator2(qs,qe,res,N,offset);
}

int ArrayConfigspace::indicator2_async_wait(int request){return 0;}
