...
It has shown that this part a neglectible amount of time compared to the graph building phase.
...
\end{tabular}
\caption{Timing results for the parallelization versions from chapter \ref{solver} on a machine with 4 GeForce GTX 480}
\end{table}
