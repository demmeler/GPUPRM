...
Boltzmannstraße 3,
85748 Garching by Munich \\  %TODO: which adresses to use?
\email{manfred.liebmann@tum.de}
}
...
For example in robot motion planning, where the dimensions of the underlying spaces are rather high, this can be expensive. 
